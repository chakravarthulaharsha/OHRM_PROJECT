...
public static void launch_browser(String browser,String url) {
	String ch_driver_path="H:\\eclipsejava\\CTS_ORANGEHRM\\src\\test\\resources\\drivers\\chromedriver.exe";
	String ff_driver_path="H:\\eclipsejava\\CTS_ORANGEHRM\\src\\test\\resources\\driver\\geckodriver.exe";
	switch(browser) {
	case "chrome":
